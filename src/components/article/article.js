...
function articleMaker(articleObj) {
  ...
  articleWrapper.appendChild(articlePar1);
  articleWrapper.appendChild(articlePar2);
  articleWrapper.appendChild(articlePar3);
  articleWrapper.appendChild(expandButton);

  articleTitle.textContent = articleObj.title;
  articleDate.textContent = articleObj.date;
  articlePar1.textContent = articleObj.firstParagraph;
  articlePar2.textContent = articleObj.secondParagraph;
  articlePar3.textContent = articleObj.thirdParagraph;
